...
def check_in_stock(url):
    ...
    # Corrected the typo here, use 'Service' with capital 'S'
    service = Service(executable_path="/home/drew/Desktop/5090 bot/chromedriver")  # Ensure this path is correct
    driver = webdriver.Chrome(service=service, options=chrome_options)  # Pass the Service object here
...
class StockCheckApp(tk.Tk):
    ...
    def play_sound_alert():
        playsound("/home/drew/Desktop/5090 bot/attention.mp3")
